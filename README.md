`네카라쿠배당토`에서 좋아하는 README는 \*\*'이 프로젝트를 왜(Why) 만들었는지, 기술적으로 어떤(How) 도전을 했는지, 그래서 무엇(What)을 할 수 있는지'\*\*가 명확하게 드러나는 README입니다.

단순히 "1단계"가 아니라, 프로젝트의 \*\*최종 비전(Vision)\*\*을 중심으로 작성해야 합니다.

아래 템플릿을 `README.md` 파일에 복사/붙여넣기 하시고, `[ ]` 괄호 안의 내용만 본인에게 맞게 수정해서 사용하세요.

-----

(아래 내용을 `README.md` 파일에 복사하세요)
